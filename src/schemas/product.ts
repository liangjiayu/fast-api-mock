...
export const ProductSchema = z
  .object({
    ...
    description: z
      .string()
      .openapi({ description: '商品描述', example: '高品质无线蓝牙耳机，支持降噪' }),
    image: z
      .string()
      .url()
      .openapi({ description: '商品图片', example: 'https://picsum.photos/seed/product1/200/200' }),
  })
  .openapi('Product');

export const ProductListResponseSchema =
  createPaginatedResponse(ProductSchema).openapi('ProductListResponse');
